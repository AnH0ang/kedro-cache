...
from kedro_cache.framework.cli.cli import TEMPLATE_FOLDER_PATH
...
@pytest.fixture
def kedro_project_with_cache_config(kedro_project: Path) -> Path:
    ...
    write_jinja_template(
        src=TEMPLATE_FOLDER_PATH / "cache.yml",
        is_cookiecutter=False,
        dst=kedro_project / "conf" / "local" / "cache.yml",
